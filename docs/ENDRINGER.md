# Endringslogg - Min Første Website v2

**Prosjekt:** Min Første Website  
**Versjon:** v1 → v2  
**Dato startet:** 11. november 2025

---

## 📋 Oversikt

Dette dokumentet holder oversikt over alle endringer gjort i oppgraderingen fra v1 til v2.

---

## 🗓️ Endringshistorikk

### 2025-11-11 - Prosjektoppstart

#### Dokumentasjon
- ✅ Opprettet `docs/` mappe
- ✅ Opprettet `ARBEIDSPLAN.md` - Detaljert plan for hele prosjektet
- ✅ Opprettet `BILDER_PLAN.md` - Oversikt over nødvendige assets
...
- Holder oss til planen i ARBEIDSPLAN.md
- Dokumenterer alle større endringer her
- Oppdateres kontinuerlig gjennom prosjektet
